...
public class TieredDrillActorInstance extends ActorInstance {

    ActorData drillHead;
    private final Direction facing;

    public TieredDrillActorInstance(MaterialManager materialManager, VirtualRenderWorld contraption, MovementContext context) {
        ...
        drillHead = material.getModel(DrillTierRegisterer.getHead(state), state).createInstance();
